...
Através desse projeto será feito uma pequena modificação no sistema de segurança da
motocicleta que vai receber alguns Relés(interruptores) e um leitor de RFID agregado a uma 
placa arduino nano(microcontrolador) que vão ficar ligados a ignição da moto e como um todo 
a sua parte eletrica, ou seja, a mesma só vai responder a um chip que de possui um codigo
